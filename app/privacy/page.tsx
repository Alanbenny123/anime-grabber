        ...
        <div className="container mx-auto px-4">
          ...
          <div className="bg-[#171717] rounded-lg p-6 md:p-8 mb-8">
            <div className="prose prose-invert max-w-none">
              <p className="mb-4">
                At AnimeGrabber, we are committed to protecting your privacy.
              ...
              <p className="mb-4">
                When you create an account or subscribe to our newsletter, we
              ...
              <h3 className="text-lg font-medium mb-3 mt-6">Financial Data</h3>
              <p className="mb-4">
                We do not collect any payment or financial information directly.
                If you make a donation or pay for premium services, all payment
                information is processed through our payment processor, and we
                do not store your financial data.
              </p>
              ...
              <p className="mb-4">
                ...
                and grant the website permission to access this information.
              </p>
              ...
              <p className="mb-4">
                ...
                website and improve your experience. For more information on how
                we use cookies, please refer to our Cookie Policy posted on the
                website.
              </p>
              ...
              <p className="mb-4">
                ...
                <a
                  href="mailto:privacy@animegrabber.to"
                  className="text-blue-500"
                >
                  privacy@animegrabber.to
                </a>
              </p>
            </div>
          </div>
