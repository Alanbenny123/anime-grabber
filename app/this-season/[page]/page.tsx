...
export function generateMetadata({ params }: Props) {
  ...
  return {
    title: `This Season Anime - Page ${page} - AnimeGrabber`,
    description: `Browse page ${page} of currently airing anime series this season in HD quality.`,
  };
}
...
const TOTAL_PAGES = Math.ceil(topAiringAnime.length / ITEMS_PER_PAGE);
...
export default function ThisSeasonPage({ params }: Props) {
  ...
  const currentAnime = topAiringAnime.slice(startIndex, endIndex);
